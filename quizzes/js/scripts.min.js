...
jQuery(document).ready(function(o){function r(){c.each(function(){$this=o(this);var r=o('#cd-vertical-nav a[href="#'+$this.attr("id")+'"]').data("number")-1;$this.offset().top-o(window).height()/2<o(window).scrollTop()&&$this.offset().top+$this.height()-o(window).height()/2>o(window).scrollTop()?t.eq(r).addClass("is-selected"):t.eq(r).removeClass("is-selected")})}function s(r){o("body,html").animate({scrollTop:r.offset().top},600)}o(".red-button").click(function(){return o(".first .arrow, .first .facebook").is(":visible")?(o(".first .arrow, .first .facebook-first").hide("slow"),o(".red-button").css("top","93%"),o(".first").css("background-color","#0195C9"),o(".first .fa-arrow-right").css("display","inline-block")):(o(".first .arrow, .first .facebook-first").show("slow"),o(".red-button").css("top","80%"),o(".first").css("background-color","rgba(1, 149, 201, .6)"),o(".first .fa-arrow-right").css("display","inline-block")),!1}),o(".second .green-button").click(function(){return o(".second .arrow, .second .facebook").is(":hidden")?(o(".second .arrow, .second .facebook").show("slow"),o(".second .green-button").css("top","80%"),o(".second").css("background-color","rgba(255, 255, 255, .6)"),o(".second .fa-arrow-right").css("display","none")):(o(".second .arrow, .second .facebook").hide("slow"),o(".second .green-button").css("top","93%"),o(".second").css("background-color","#fff"),o(".second .fa-arrow-right").css("display","inline-block")),!1}),o(".blue-button").click(function(){return o(".third .arrow, .third .facebook").is(":hidden")?(o(".third .arrow, .third .facebook").show("slow"),o(".blue-button").css("top","80%"),o(".third").css("background-color","rgba(1, 149, 201, .6)")):(o(".third .arrow, .third .facebook").hide("slow"),o(".blue-button").css("top","93%"),o(".third").css("background-color","#B3D5DF")),!1}),o(".popup").magnificPopup({type:"iframe"}),o(".left-lot").niceScroll({cursoropacitymin:"1",cursorborderradius:"0",background:"#EDEDED",cursorborder:"1px solid #6C6C6C",cursorcolor:"#6C6C6C",cursorwidth:"4px"});var c=o(".cd-section"),t=o("#cd-vertical-nav a");r(),o(window).on("scroll",function(){r()}),t.on("click",function(r){r.preventDefault(),s(o(this.hash))}),o(".cd-scroll-down").on("click",function(r){r.preventDefault(),s(o(this.hash))})});